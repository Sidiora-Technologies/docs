...
:::note
Before proceeding with the CLI, please insure you have `evmosd` installed. Installation instruction are located [here](./../../protocol/Paxeer-Network-cli/single-node).
:::
